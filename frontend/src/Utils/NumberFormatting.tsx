...
export const formatLargeMonetaryNumber: any = (number: number) => {
  ...
  if (number < 0) {
    return (
      <div className="te">
        <span>-</span>
        {formatLargeMonetaryNumber(-1 * number)}
      </div>
    );
  }
  if (number < 1000) {
    ...
    return (
      <>
        ...
        <span className="number-value">
          {result % 1 === 0 ? result.toFixed(1) : result.toFixed(2)}
        </span>
      </>
    );
    ...
    return (
      <>
        ...
        <span className="number-value">
          ...
          <span className="number-suffix">K</span>
        </span>
      </>
    );
    ...
    return (
      <>
        ...
        <span className="number-value">
          {result % 1 === 0 ? result.toFixed(0) : result.toFixed(1)}
          <span className="number-suffix">M</span>
        </span>
      </>
    );
    ...
    return (
      <>
        ...
        <span className="number-value">
          ...
          <span className="number-suffix">B</span>
        </span>
      </>
    );
    ...
    return (
      <>
        ...
        <span className="number-value">
          {result % 1 === 0 ? result.toFixed(0) : result.toFixed(2)}
          <span className="number-suffix">T</span>
        </span>
      </>
    );
  }
